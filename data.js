...
const SUBJECTS = [
  ...
  },
  {
    ...
    options: [
      { id: "STD", label: "Standard", teacher: "Ms. Asima Raza", sessions: [{d:"MON",s:7},{d:"WED",s:2},{d:"THUR",s:3},{d:"FRI",s:2}] },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { id: "G2", label: "G2", teacher: "Mr. Ahmad Javed", sessions: [{d:"TUE",s:5},{d:"WED",s:6},{d:"THUR",s:5}] },
  ...
  },
  {
    ...
    options: [
      ...
      { id: "G3", label: "G3", teacher: "Mr. Asad Afzaal", sessions: [{d:"TUE",s:6},{d:"WED",s:5},{d:"THUR",s:8}] },
  ...
  },
  {
    ...
    options: [
      { id: "G1", label: "G1", teacher: "Mr. Jibran Kamran", sessions: [{d:"WED",s:3},{d:"FRI",s:7},{d:"SAT",s:6}] },
      ...
      { id: "G5", label: "G5", teacher: "Mr. Hamiz Javed", sessions: [{d:"TUE",s:5},{d:"FRI",s:6},{d:"SAT",s:1},{d:"SAT",s:2}] },
  ...
  },
  {
    ...
    options: [
      { id: "G1", label: "G1", teacher: "Mr. Ahmed Waheed", sessions: [{d:"MON",s:5},{d:"THUR",s:4},{d:"THUR",s:5}] },
      { id: "G2", label: "G2", teacher: "Mr. Ahmed Waheed", sessions: [{d:"MON",s:6},{d:"WED",s:6}] },
    ],
  },
  {
